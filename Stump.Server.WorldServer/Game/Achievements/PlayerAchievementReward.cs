...
namespace Stump.Server.WorldServer.Game.Achievements
{
    ...
    public class PlayerAchievementReward
    {
        ...
        public IEnumerable<AchievementRewardable> GetRewardableAchievements()
        {
            foreach (var item in this.m_rewardAchievements)
            {
                yield return new AchievementRewardable((ushort)item.Id, this.m_rewardLevel);
            }
