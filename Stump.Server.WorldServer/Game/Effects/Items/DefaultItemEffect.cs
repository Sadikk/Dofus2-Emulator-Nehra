...
namespace Stump.Server.WorldServer.Game.Effects.Handlers.Items
{
	...
	public class DefaultItemEffect : ItemEffectHandler
	{
		...
		private static readonly System.Collections.Generic.Dictionary<PlayerFields, DefaultItemEffect.EffectComputeHandler> m_addMethods = new System.Collections.Generic.Dictionary<PlayerFields, DefaultItemEffect.EffectComputeHandler>
		{
		...
		private static readonly System.Collections.Generic.Dictionary<EffectsEnum, PlayerFields> m_subEffectsBinds = new System.Collections.Generic.Dictionary<EffectsEnum, PlayerFields>
		{
		...
		public DefaultItemEffect(EffectBase effect, Character target, BasePlayerItem item) : base(effect, target, item)
		{
		}
		public DefaultItemEffect(EffectBase effect, Character target, ItemSetTemplate itemSet, bool apply) : base(effect, target, itemSet, apply)
		{
		}
		public override bool Apply()
		{
			...
			{
				DefaultItemEffect.EffectComputeHandler effectComputeHandler;
