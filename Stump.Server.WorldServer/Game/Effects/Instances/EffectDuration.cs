...
namespace Stump.Server.WorldServer.Game.Effects.Instances
{
	...
	public class EffectDuration : EffectBase
	{
		...
		public EffectDuration(EffectDuration copy) : this(copy.Id, copy.m_days, copy.m_hours, copy.m_minutes, copy)
		{
		}
		...
		public EffectDuration(EffectInstanceDuration effect) : base(effect)
		{
		...
		{
            return new ObjectEffectDuration((ushort)base.Id, (ushort)this.m_days, (sbyte)m_hours, (sbyte)this.m_minutes);
		}
