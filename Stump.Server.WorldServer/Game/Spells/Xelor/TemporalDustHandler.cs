...
{
    [SpellCastHandler(SpellIdEnum.TemporalDust)]
    public class TemporalDustHandler : DefaultSpellCastHandler
    {
        //aiguillde
        public TemporalDustHandler(FightActor caster, Spell spell, Cell targetedCell, bool critical) : base(caster, spell, targetedCell, critical)
        {
        }
