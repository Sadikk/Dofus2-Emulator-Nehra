...
{
    [SpellCastHandler(SpellIdEnum.DarkRay)]
    public class DarkRayHandler : DefaultSpellCastHandler
    {
        //aiguillde
        public DarkRayHandler(FightActor caster, Spell spell, Cell targetedCell, bool critical) : base(caster, spell, targetedCell, critical)
        {
        }
        ...
        public override void Execute()
        {
            ...
            //todo : double damage if telefrag ? idk
        }
    }
}