...
namespace Stump.Server.BaseServer.Database
{
	public class DiscriminatorManager<T> : Singleton<DiscriminatorManager<T>>
	{
		...
		public void Initialize(Assembly assembly)
		{
			...
			{
				Type type = types[i];
				DiscriminatorAttribute customAttribute = type.GetCustomAttribute<DiscriminatorAttribute>();
		...
		{
			this.CheckBeforeGenerate(discriminator, Assembly.GetCallingAssembly());
